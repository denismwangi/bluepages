...
<div class="col-xl-12 col-md-12">
                    ...
                    ?>
                                        ...
                                        <div class="col-sm-9 col-auto align-self-right font-18" >
...
<?php
         ...
         ?>
           ...
           <br>
            ...
            echo   form_open_multipart('admin/forum/post_comment/'.$month.'/'.$year.'/'.$post->id, $attributes); 
            ?>
         ...
         <script>
                    ...
                    $(document).ready(function ()
                    {
                     ...
                     $(function(){
                        const new_url = "<?php echo base_url().'admin/forum/get_comments/'.$post->id;?>";
