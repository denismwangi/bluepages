        ...
        <div class="pcoded-inner-content">
							...
							<!-- 
					                    ...
					                    <div class="col-md-5">
					                        ...
					                        <div class="pull-right" style="margin-top: 25px; padding-right: 3px;">
					                            ...
					                            <a href="<?php echo base_url().'admin/marketplace/create_categories';?>"><button class="btn btn-success" ><span style="font-size:18px;"class="fa fa-plus"></span> ADD NEW</button></a>
            ...
            <?php endif; ?>             
                    ...
                    <div class="center col-md-9 text-center">
                        <h3 style="text-align:center;"class="uppercase">Categories</h3>
                    </div><br>
        	...
        	$counter = 1; // Initialize the counter
             ...
             foreach ($categories as $cat) {
	            ...
	            <div class="btn-toolbar justify-content-center">
	                ...
	                <a href="<?php echo base_url().'admin/marketplace/edit_category/'.$cat->id; ?>" class="default-grid-item waves-effect md-trigger btn btn-primary btn-sm">EDIT</a>
