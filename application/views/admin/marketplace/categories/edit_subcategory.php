...
echo   form_open_multipart('admin/marketplace/update_subcategories/'.$subcategory->id, $attributes); 
?>
               ...
               <select name="category" class="select form-control" required="required" >
                                <option value="" selected="selected">Select Category</option>
                                    ...
                                    foreach ($categories as $cat) {
                                        ...
                                        <option value="<?php echo $cat->id; ?>" <?php if ($subcategory->category == $cat->id) echo 'selected'; ?>>
              ...
              <div class="form-group">
                ...
                <input type="text" value="<?php echo $subcategory->name; ?>" name="name" class="form-control" id="inputEmail4" value="">
              </div>
