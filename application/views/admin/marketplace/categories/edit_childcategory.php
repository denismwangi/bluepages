...
?>
               ...
               <select name="category" class="select form-control" required="required" >
                                <option value="" selected="selected">Select Category</option>
                                    ...
                                    foreach ($categories as $cat) {
                                        ?>
                                        <option value="<?php echo $cat->id; ?>" <?php if ($childcategory->category == $cat->id) echo 'selected'; ?>>  <?php echo $cat->name; ?></option>
                                        <?php
                                    }
                                    ?>
              ...
              <div class="form-group">
                ...
                <input type="text" value="<?php echo $childcategory->name; ?>" name="name" class="form-control" id="inputEmail4" value="">
              </div>
