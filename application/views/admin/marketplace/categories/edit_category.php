...
echo   form_open_multipart('admin/marketplace/update_category/'.$category->id, $attributes); 
?>
              <div class="form-group">
                <label for="inputEmail4">Category Name</label>
                <input type="text" name="name" value="<?php echo $category->name;?>" class="form-control" id="inputEmail4" value="">
              </div>
