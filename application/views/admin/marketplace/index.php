    ...
    <div class="col-md-12">
        <div class=" recent-operations-card">
        	...
        	<div class="container-fluid">
				...
				<div id="left" class="left col-lg-2 col-md-8 ">

					<br>
			
				
					 <a class="btn btn-sm btn-danger text-center" style="font-size:18px;" data-toggle="elementscroll" onclick="goBack();" href=""><i class="fa fa-caret-left"></i> PREVIOUS PAGE</b></a>
            	...
            	<div id="left" class="left col-lg-10 col-md-8 text-right">
...
<div class="container-fluid">
            	...
            	<div class="row">
					...
					<div id="left" class="left col-lg-8 col-md-8 text-left">
                    	<h3 style="text-align:center;"class="uppercase">MARKETPLACE</h3>
                        ...
                        <div class=" col-md-12 clearfix"></div>
							...
							<div class="col-lg-3 col-md-6 default-grid-item">
								<div class="card gallery-desc">                             
                                    <div class="masonry-media">
                                        <a  class="media-middle"  href="<?php echo base_url().'admin/marketplace/categories';?>">
                                            <img src="<?php echo base_url().'public/img/admin/superadmin.jpg';?>" width="100%" height="150" alt="photo" />                                                            </a>
                                    </div>
                                    <div class="home_card"style="background-color:gray;">
                                        <a  class="media-middle"  href="<?php echo base_url().'admin/marketplace/sub_categories';?>">
                                            <h6 style="color:lightgrey;" class="text-center text-18-bold">CATEGORIES</h6>
                                        </a>
                                    </div>
                                </div>
                            </div>
