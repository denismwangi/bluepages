        ...
        <div style= "border-color: blue;" class=" recent-operations-card">
        	...
        	<div class="container-fluid">
				...
				<div id="left" class="left col-lg-3 col-md-8 "  ><br>
					 ...
					 <a class="btn btn-sm btn-danger text-center" style="font-size:18px;" data-toggle="elementscroll" href="<?php echo base_url().'admin/chat';?>"><i class="fa fa-caret-left"></i> BACK TO PREVIOUS</a>
...
<div class="container-fluid">
            	...
            	<div class="row">
					...
					<div id="left" class="left col-lg-8 col-md-8 text-left">
                    	<h2 style="text-align:center;"class="uppercase">ALL CHATS</h2>
	...
	<?php 
		...
		<div class="col-lg-2 col-md-6 default-grid-item">
			<div style= "border-color: blue;"class="card gallery-desc <?php echo $bg;?>">
				<div class="masonry-media">
					<a class="media-middle" target="" href="#">
					<img src="<?php echo base_url().'public/img/postachat.jpg';?>" width="100%" height="180" alt="icons2/uploads" />					</a>
				</div>
