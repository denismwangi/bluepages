...
<div class="container-fluid">
            	...
            	<div class="row">
					...
					<div id="left" class="left col-lg-8 col-md-8 text-left">
                    	<h3 style="text-align:center;"class="uppercase">ALL POSTA LIVE</h3>
                    ...
                    <div class="row">
                        ...
                        for($i=0; $i<$limit ; $i++){
                            ...
                            if(date('Y')==$start_year){
                                $bg = 'bg-green';
                                $color = 'text-white';
                                $url = 'admin/live/months/'.$start_year;
                            }elseif(date('Y') > $start_year){
                                        $bg = 'bg-black';
                                        $url = 'admin/live/months/'.$start_year;
                                    }else{
                                        $url = 'admin/live/months/#';
                                    }
                        ?> 
								...
								<div class="card gallery-desc  <?php echo $bg;?>">                             
                                    <div class="masonry-media">
                                        <a  class="media-middle"  href="<?php echo base_url().$url;?>">
                                            <img src="<?php echo base_url().'public/img/postalive.jpg';?>" width="100%" height="130" alt="Files/board" />                                                            </a>
                                    </div>
