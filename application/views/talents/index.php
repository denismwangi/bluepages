...
<div class="container-fluid">
            	...
            	<div class="row">
					...
					<div id="left" class="left col-lg-8 col-md-8 text-left">
                    	<h2 style="text-align:center;"class="uppercase">TALENTS</h2>
...
<div class="row" >
		...
		<div class="col-lg-2 col-md-6 default-grid-item">
			<div style= "border-color: blue;"class="card gallery-desc">
				<div class="masonry-media">
				<a href="">
					<img src="<?php echo base_url().'uploads/talents/'.$subcat->image;?>" width="100%" height="180" alt="icons2/uploads" />					</a>
				</div>
				<div class="home_card">
				 <a class="media-middle" target="" href="">
