        	...
        	<div class="container-fluid">
				...
				<div id="left" class="left col-lg-3 col-md-8 ">
					...
					<br>
					 ...
					 <a class="btn btn-sm btn-danger text-center" style="font-size:18px;" data-toggle="elementscroll" href="" onclick="history.back()"><i class="fa fa-caret-left"></i> PREVIOUS PAGE</b></a>
...
<div class="container-fluid">
            	...
            	<div class="row">
					...
					<div id="left" class="left col-lg-8 col-md-8 text-left">
                    	<h3 style="text-align:center;"class="uppercase"><b>MY E-DIARY<b></h3>
                    ...
                    <div class="row">
                        ...
                        for($i=0; $i<$limit ; $i++){
                            ...
                            if(date('Y')==$start_year){
                                $bg = 'bg-green';
                                $color = 'text-white';
                                $url = 'user/diary/months/'.$start_year;
                            }elseif(date('Y') > $start_year){
                                        $bg = 'bg-black';
                                        $url = 'user/diary/months/'.$start_year;
                                    }else{
                                        $url = 'user/diary/months/#';
                                    }
                        ?>  
								...
								<div class="card gallery-desc  <?php echo $bg; ?>">                             
                                    <div class="masonry-media">
                                        <a  class="media-middle"  href="<?php echo base_url().$url; ?>">
                                            <img src="<?php echo base_url().'public/img/ediary.jpg';?>" width="100%" height="180" alt="Files/board" />                                                            </a>
                                    </div>
