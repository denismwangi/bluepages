						...
						<div class="container-fluid">
							...
							<div class="row">
									...
									<div id="right" class="right col-lg-2 col-md-8 "  ><br>
										 ...
										 <a class="btn btn-sm btn-danger text-center" style="font-size:18px;" data-toggle="elementscroll" href="/"><i class="fa fa-caret-left"></i> BACK TO HOME PAGE</a>
									...
									<div  class="left col-lg-2 col-md-8 "  >								
										...
										<div class="col-lg-8 col-md-8 default-grid-item">
											<div style= " background-color:lightblue; border-color: blue;"class="card gallery-desc">
														...
														<div class="col-lg-8">
															<h2 style=" color:black;text-align:center;"><b>  FRONT SEAT IMAGE ADVERT </b> </h2>
															<p style=" color:brown;text-align:center;font-size:17;"><b>Your advert will always appear on the front landing page<b></p>
														...
														<div class="col-lg-5">
															<h4 style=" color:black;"><b>  Front seat advert </b> </h4>
