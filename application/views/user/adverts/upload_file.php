						...
						<div class="container-fluid">
							...
							<div class="row">
									...
									<div id="left" class="left col-lg-3 col-md-8 "  ><br>
										 ...
										 <a class="btn btn-sm btn-danger text-center" style="font-size:18px;" data-toggle="elementscroll" href="/items/design.php"><i class="fa fa-caret-left"></i> BACK TO PREVIOUS PAGE</a>
									...
									<div id="right" class="right col-lg-2 col-md-8 "  ><br>
										 ...
										 <a class="btn btn-sm btn-danger text-center" style="font-size:18px;" data-toggle="elementscroll" href="/contacts/user.php"><i class="fa fa-caret-left"></i> BACK TO HOME PAGE</a>
										...
										<div class="col-lg-8 col-md-8 default-grid-item">
											<div style= " background-color:lightblue; border-color: blue;"class="card gallery-desc">
														...
														<div class="col-lg-5" Style="margin-top:7">
															<h4 style=" color:white;margin-left:10"><b>  SELECT TYPE OF ADVERTISEMENT </b> </h4>
													...
													<div class="col-lg-7"Style="margin-top:11;text-align:right">
														...
														<div class="col-lg-8">
															<h2 style=" color:black;text-align:center;"><b>  IMAGE ADVERT </b> </h2>
															<p style=" color:brown;text-align:center;font-size:17;"><b>A picture is worth a thousand words<b></p>
														...
														<div class="col-lg-5">
															<h4 style=" color:black;"><b>  Front cover page image advert </b> </h4>
																	...
																	<form action="/action_page.php">
																	  ...
																	  <div class="form-group">
																			...
																			<textarea Style="resize:none;text-transform: none;"class="form-control" id="exampleFormControlTextarea1" rows="2">Brief image description (only two rows acceptable)</textarea>
																	  </div>
														...
														<div class="col-lg-6"><h4 style=" color:black;"><b> Other Images to scroll (optional) </b> </h4></div>
														...
														<div class="row">
																	...
																	<div class="col-lg-10"style="font-size:15px;text-align:center;margin-bottom:10">
																				<a class="btn btn-sm btn-success "  data-toggle="elementscroll" href="<?php echo base_url().'user/adverts/preview_file';?>"><i class="fa fa-caret-right"></i> PREVIEW</a>
