        	...
        	<div class="container-fluid">
				...
				<div id="left" class="left col-lg-3 col-md-8 ">
					...
					<br>
					 ...
					 <a class="btn btn-sm btn-danger text-center" style="font-size:18px;" data-toggle="elementscroll" href="<?php echo base_url().'user/adverts';?>"><i class="fa fa-caret-left"></i> BACK TO PREVIOUS PAGE</b></a>
...
<div class="container-fluid">
            	...
            	<div class="row">
					...
					<div id="left" class="left col-lg-8 col-md-8 text-left">
                    	<h3 style="text-align:center;"class="uppercase">MY ADVERTS</h3>
                    ...
                    <div class="row">
                        ...
                        for($i=0; $i<$limit ; $i++){
                            ...
                            if(date('Y')==$start_year){
                                $bg = 'bg-green';
                                $color = 'text-white';
                                $url = 'user/adverts/list/'.$start_year;
                            }elseif(date('Y') > $start_year){
                                        $bg = 'bg-black';
                                        $url = 'user/adverts/list/'.$start_year;
                                    }else{
                                        $url = 'user/adverts/years/#';
                                    }
                        ?>  
