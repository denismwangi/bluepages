						...
						<div class="container-fluid">
							...
							<div class="row">
									...
									<div id="left" class="left col-lg-3 col-md-8 "  ><br>
										 ...
										 <a class="btn btn-sm btn-danger text-center" style="font-size:18px;" data-toggle="elementscroll" href="<?php echo base_url().'user/home';?>"><i class="fa fa-caret-left"></i> BACK TO PREVIOUS PAGE</a>
									...
									<div  class="left col-lg-3 col-md-8 "  >								
										...
										<div class="col-lg-6 col-md-8 default-grid-item">
											<div style= " background-color:lightblue; border-color: blue;"class="card gallery-desc">
														...
														<h4 style=" text-align:center;color:white;"><b>  SELECT YOUR TYPE OF ADVERTISEMENT </b> </h4>
														...
														<div  class="row"  >
														       ...
														       <div class="col-lg-2 col-md-8 default-grid-item"></div>
														      <div class="col-lg-8 col-md-8 default-grid-item">
															  
															         <div class="row">
																		  <div class="col-md-6 default-grid-item">
																				<div class="card gallery-desc">
																					<div class="masonry-media">
																						<a class="media-middle" href="<?php echo base_url().'user/adverts/years';?>">
																							<img src="<?php echo base_url().'public/img/bluepages.png';?>" width="100%" height="180" alt="icons2/Institution2">                            </a>
																					</div>
																					<div class="home_card" style="background-color:#0760f0;">
																						<a class="media-middle" href="<?php echo base_url().'user/adverts/years';?>">
																							<h4 class="text-center text-18-bold"style="color:white;"><b>MY ADVERTS</b> </h4>
																						</a>
																					</div>
																				</div>
																			</div>
																			 ...
																			 <div class="col-md-6 default-grid-item">
																				 <div class="card gallery-desc">
																					<div class="masonry-media">
																						<a class="media-middle" href="<?php echo base_url().'user/adverts/business_contact';?>">
																							<img src="<?php echo base_url().'public/img/bluepages.png';?>" width="100%" height="180" alt="icons2/Institution2">                            </a>
																					</div>
																					<div class="home_card"style="background-color:#0760f0;">
																						<a class="media-middle" href="<?php echo base_url().'user/adverts/business_contact';?>">
																							<h4 class="text-center text-18-bold"style="color:white;"><b>MY BUSINESS(ES)</b> </h4>
																						</a>
																					</div>
																				</div>
																			</div>
														...
														<div class="row">
																	...
																	<div class="col-lg-8"style="font-size:15px;text-align:center;margin-bottom:10">
															<h6 class="text-center text-18-bold">  You can advertise your business(es) contacts, services and products in different

															targeted counties as many times as you like.</h6>
