...
class Forum extends CI_Controller {
	...
	public function index(){
		  ...
		  $this->load->view('admin/forum/index');	
	}

	public function months($year){

		$data['year'] = $year;
		$this->load->view('admin/forum/months',$data);	
	}
	...
	public function list($month,$year)
	{
        ...
        function create($month,$year)
        {
		    ...
		    $this->load->view('admin/forum/create',$data); 
			...
			function post_comment($month,$year,$id)
	{
		...
		//	 }
			   ...
			   redirect( 'admin/forum/join/'.$month.'/'.$year.'/'.$id);
